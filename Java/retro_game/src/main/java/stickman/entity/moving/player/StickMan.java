...
public class StickMan extends MovingObject implements Controllable {
    ...
    public Entity entityCopy() {
        StickMan stickMan = new StickMan(this.xPos, this.yPos, "normal", this.level);
        stickMan.imagePath = this.imagePath;
        stickMan.setUpgraded(this.upgraded());
        stickMan.setSize(this.size);
        stickMan.setWidth(this.getWidth());
        stickMan.setHeight(this.getHeight());
        stickMan.setLeft(this.left);
        stickMan.setRight(this.right);
        stickMan.setLeftFacing(this.leftFacing);
        stickMan.setYVel(this.yVelocity);
        stickMan.setXVel(this.xVelocity);
        stickMan.yPos = this.yPos;
        stickMan.xPos = this.xPos;
        stickMan.active = this.active;
    ...
    public void setUpgraded(boolean value){
        this.upgraded = value;
    }
    ...
    public void setLeftFacing(boolean value){
        this.leftFacing = value;
    }
